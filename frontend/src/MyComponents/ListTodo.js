                        ...
                        todos.map(todo =>
                            <tr key={todo.id}>
                                ...
                                <td>
                                    ...
                                    <button className='btn btn-success' onClick={()=>markCompleteTodo(todo.id)} style={{marginLeft:"10px"}}>Mark as Completed</button>
                                    <button className='btn btn-danger' onClick={()=>markInCompleteTodo(todo.id)} style={{marginLeft:"10px"}}>Mark as InCompleted</button>
                                </td>
                            </tr>
                        )
                    }
